$(function(){       //funcao para dados da ONG
    ...
    $('#cnpjong').mask('00.000.000/0000-00', {reverse: true}); //maslparacnpj

    $('#fonedoador').mask('(00) 00000-0000'); //maskparatelefone

    $('#hora').mask('00:00-00:00', {reverse: true}); //mascarafuncionamento
...
$(function(){
    ...
    $('#telrepresentante').mask('+55 (00) 00000-0000')
