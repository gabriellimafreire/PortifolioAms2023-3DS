...
<head>
    ...
    <title>Doação Monetaria Recebida</title>

    @vite([
        'resources/css/app.css', 
        'resources/css/DoacaoMonetariaRecebida.css', 
        'resources/js/app.js',
...
<div class="Titulos">
    ...
    <div class="DadosDoacao container">
        <h4><p>Nome do Doador: </p>&nbspJosias de Almeida</h4>
        <h4><p>Data da Doação: </p> 12/08/2023</h4>
    </div>


    <div class="DoacaoMaterial container">
        <h3 style="color: #275950!important;">Descrição</h3>
        <h4><p>Tipo de doação:</p>&nbsp Monetária</h4>
        <h3><p>Valor:</p>&nbsp R$ 50,00</h3>
    </div>
