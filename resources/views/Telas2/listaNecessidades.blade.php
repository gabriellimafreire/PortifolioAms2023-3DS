...
<head>
    ...
    <title>Lista de Necessiades | BY HOPE IN LIFE</title>
...
<body style="background:#64CCC9; position:absolute; min-height: 100hv;">
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="{{Route('home')}}"><img src="{{Vite::asset('resources/img/HL - Logotipo - SEM LETREIRO.png')}}" class="logo"></a>
              ...
              <li class="nav-item">
                  ...
                  <li class="nav-item">
                      <a class="nav-link active" href="{{Route('ListarNecessidades')}}">Necessidades</a>
                  </li>
...
<center class="Titulo01">Necessidades</center>
<br><br>
  ...
  <div class="row m-0" style="vertical-align: middle;">
    <div class="col-3 px-0 text-center asd" style="vertical-align: middle;">
        <form>
        <button type="submit" class="btn" style="border-radius: 0px; background: #26874E; width: 100%; height: 100%;"><div style="color: #FFF; font-family: Inter; font-size: 30px; font-style: normal; font-weight: 800; line-height: normal;">Pesquisar</div></button>
    </div>
    <div class="col px-0">
        <input type="text" class="form-control #FAF3F3 asd2 h-100" style="border-radius: 0px;">
        </form>
    </div>
  </div>
    </div>
    ...
    <!--Necessiades de Destaque-->
    <div class="container">
        <div class="row">
            <div class="col">
            <div class="card h-100 item" style="background-color: #9BF2EA; text-decoration: none;">
            <div style="background-color: #41BFB3; margin-left: 70%; padding: 5px;"><center class="estilo01">Aberta</center></div>
            <center><br>
            <a href="#" class="Titulo02" style="text-decoration: none;">SASA Apoio à IDOSOS</a><br>
            <a href="#" class="Titulo03" style="text-decoration: none;">Fralda Geriátrica</a><br><br>
            </center>
                <a href="#"><img src="{{Vite::asset('resources/img/Fraldas.png')}}" class="card-img-top imagemfit" alt="..." height="220px"></a><br>
            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-body" style="text-decoration: none;">
                <p class="card-text estilo02">A ONG de Apoio à Idosos SASA presta serviços visando uma maior qualidade de vida para as pessoas que formam a faixa etária mais velha de SP. Necessita-se de 10 pacotes de fraldas geriátricas para doar a duas famílias de idosos.</p>
            </a>
            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-footer bg-transparent border-0" style="text-decoration: none;">
                <div class="container-fluid" style="background-color: #64CCC9;">
                    <div class="row">
                        <div class="col" style="text-align: left;">
                        meta de doação: 02/10
                        </div>
                ...
                <br>
                <div class="estilo03">São Paulo, SP - Itaquera, Rua Campinas do Piauí </div>
            </a>
            </div> <!--fim do card-->
            </div> <!--fim da col-->
            ...
            <div class="card h-100" style="background-color: #9BF2EA;">
            <div style="background-color: #CE1C30; margin-left: 70%; padding: 5px;"><center class="estilo01">Encerrada</center></div>
            <center><br>
            <a href="#" class="Titulo02" style="text-decoration: none;">Base de Alimentos</a><br>
            <a href="#" class="Titulo03" style="text-decoration: none;">Cesta de Alimentos</a><br><br>
            </center>
                <a href="#"><img src="{{Vite::asset('resources/img/Cesta.png')}}" class="card-img-top imagemfit" alt="..." height="220px"></a><br>
            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-body" style="text-decoration: none;">
                <p class="card-text estilo02">Nós da Base de Alimentos buscamos ajudar as pessoas em situação de insegurança.
                Atualmente estamos recebendo doações monetárias para completar as ultimas cestas desse mês.</p>
            </a>
            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-footer bg-transparent border-0" style="text-decoration: none;">
                <div class="container-fluid" style="background-color: #64CCC9;">
                    <div class="row">
    ...
    <div class="row row-cols-3 m-2">
        ...
        <div class="card h-100" style="background-color: #9BF2EA; border-radius: 0px;">
        <div style="background-color: #41BFB3; margin-left: 70%; padding: 5px;"><center class="estilo01">Aberta</center></div>
            <center>
            ...
            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="card-body border-top border-black" style="text-decoration: none;">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body ">
        <div class="container">
            <div class="row">
                <div class="col">
                    <img src="{{Vite::asset('resources/img/Fraldas.png')}}" alt="" width="300px" height="300px">
                </div>
                <div class="col">
                    <div class="descricao">
      ...
      <div class="modal-footer">
        ...
        <a type="button" class="btn btn-primary" href="{{Route('RealizarDoacaoMaterial')}}">Doar</a>
      </div>
    </div>
  </div>
</div>
