...
<br><br>
    <div class="container">
        <div class="Titulo01" style="font-size: 40px;">Confirme a desativação da sua conta no seu email</div>
        <div class="estilo04">Enviamos um e-mail para você confirmar que deseja<br> desativar sua conta </div>
    </div>
</div>
