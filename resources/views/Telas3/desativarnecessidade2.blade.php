...
<body class="body"><br><br><br><br><br>

   <center> <div class="card" style="background-color:#9BF2EA;">

        <br><br><h2>Desativar Necessidade</h2><br><br>

        <p>Necessidade desativada com sucesso!</p><br><br><br>

        <div class="botoes justify-content-md-end">
            <button style="background-color: #275950;color: white;"class="btn" type="submit">Ver Necessidades</button>&nbsp;&nbsp;&nbsp;<br><br>
        </div><br>
